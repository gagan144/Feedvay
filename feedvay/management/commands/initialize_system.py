...
class Command(BaseCommand):
    ...
    **Authors**: Gagandeep Singh
    ...
    def db_languages(self):
        """
        Initializes 'Language' database and 'Translations' collection that contains
    ...
    # def db_themes(self):
    #     """
    #     Initializes theme databases: Theme, ThemeSkin
    #     """
    ...
    def handle(self, *args, **options):
        ...
        # # (1) Create database entries for themes
