...
class BusinessServicePoint(Document):
    ...
    **Authors**: Gagandeep Singh
    ...
    HELP_TEXT = {
        "bsp_uid": "Unique ID for the BSP generated by Feedavy.",
        ...
        "website": "Your website/URL to view the BSP.",
    ...
    # Stats
    avg_rating  = FloatField(default=None, confidential=True, help_text="Average rating.")
